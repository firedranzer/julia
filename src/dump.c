...
static jl_value_t *_jl_restore_incremental(jl_module_t *from, ios_t *f, jl_array_t *mod_array)
{
    jl_ptls_t ptls = jl_get_ptls_states();
    ...
    jl_value_t *verify_fail = read_verify_mod_list(from, f, &dependent_worlds, mod_array);
    if (verify_fail) {
...
JL_DLLEXPORT jl_value_t *jl_restore_incremental_from_buf(jl_module_t *from, const char *buf, size_t sz, jl_array_t *mod_array)
{
    ios_t f;
    ios_static_buffer(&f, (char*)buf, sz);
    return _jl_restore_incremental(from, &f, mod_array);
}

JL_DLLEXPORT jl_value_t *jl_restore_incremental(jl_module_t *from, const char *fname, jl_array_t *mod_array)
{
    ios_t f;
